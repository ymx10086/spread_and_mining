...
def parse_args():
    ...
    parser.add_argument("--file_dir", default="../../data/央视春晚A平台数据", help="which root file to build graph for")  # TODO: change this for reading different data
    parser.add_argument("--graph_bin_path", default='../../build/graph_bin_data', help="save graph binary file")
